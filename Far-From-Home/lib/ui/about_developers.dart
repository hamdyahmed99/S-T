        ...
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              getDevCard(
                  context,
                  'https://github.com/hamdyahmed99',
                  'Hamdy Elredi',
                  'https://www.linkedin.com/in/hamdyahmed99/',
                  'Web Developer,\nUI  & Flutter Developer',
                  'mailto:hamdyelready@gmail.com',
                  'assets/developers/hamdy.jpg'),
              SizedBox(
                height: size.getWidthPx(10),
              ),
              getDevCard(
                  ...
                  'linkedin/Osama',
                  'Flutter Developer',
                  'mailto:Osama@charusat.edu.in',
                  'assets/developers/profile.jpg'),
              SizedBox(
                height: size.getWidthPx(10),
              ),
            ],
