...
class _PaymentPageState extends State<PaymentPage> {
  ...
  late String _mobileNo, _name, _email, _city, _propertyName;
  late double _amount;
  var _startDate, _lastDate;
  late Screen size;
  late DateTime _sdate, _ldate;
  ...
  void initState() {
    ...
    owner = {
      ...
      'address':
          docsSnap.data()!.containsKey('address') ? docsSnap['address'] : '',
