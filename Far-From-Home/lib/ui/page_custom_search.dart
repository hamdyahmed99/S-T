...
class CustomSearchState extends State<CustomSearchPage> {
  ...
  var propertyType = ["one floor", "Apartment"];
  var propertyIcon = ["bunglow.png", "flat.png"];
  var propertyColor = [
    Color(0xff3ABBFA),
    Color(0xffFBBF36),
    Color(0xff83E934),
  ...
  String _lowerValueString =
      NumberFormat.compactCurrency(decimalDigits: 0, symbol: '\E')
          .format(_minlowerValue * 100);
  static double _maxupperValue = 100.0;
  String _upperValueString =
      NumberFormat.compactCurrency(decimalDigits: 0, symbol: '\E')
          .format(_maxupperValue * 100);
  String _upperValueFormatted =
      NumberFormat.compactCurrency(decimalDigits: 0, symbol: '\E')
          .format(_upperValue * 100);

  String _lowerValueFormatted =
      NumberFormat.compactCurrency(decimalDigits: 0, symbol: '\E')
          .format(_lowerValue * 100);

  // Value of Featured City starting from -1 : All city | ... in order mentioned in cityList[] in  line 28
        ...
        child: Container(
          child: Column(
            children: <Widget>[
              ...
              leftAlignText(
                  text:
                      "Rent Range (EGY): $_lowerValueFormatted  to $_upperValueFormatted",
                  leftPadding: size.getWidthPx(16),
                  textColor: textPrimaryColor,
                  fontSize: size.getWidthPx(16)),
              SizedBox(
