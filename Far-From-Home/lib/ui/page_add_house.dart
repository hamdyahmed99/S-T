...
class _WallState extends State<Wall> {
  ...
  bool validateAndSave() {
    ...
    if (form!.validate()) {
      ...
      print('_Governorate ${_city}');
      print('_City ${_city}');
      print('_State ${_state}');
      print('_Address ${_address}');
      print('_ PostNumber ${_pincod}');
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (value) =>
                          value!.isEmpty ? 'Governorate is required' : null,
                    ),
                    TextFormField(
                    ...
                    // ),
                    TextFormField(
                      decoration: InputDecoration(labelText: 'Post Number'),
                      style: new TextStyle(
                        fontFamily: "Poppins",
                        fontSize: 16.0,
                      ),
                      ...
                      validator: (value) =>
                          value!.isEmpty ? 'Post number is required' : null,
                    ),
                    Align(
...
class _MultiImageState extends State<MultiImage> {
  ...
  //var imageDataPath = { };
  late int i = 0, len;
  Future<void> _addImages(Asset pic) async {
    File file = await getImageFileFromAssets(pic);
    filePath = '${DateTime.now()}.png';
    FirebaseStorage storage = FirebaseStorage.instance;
    Reference ref = storage
        .refFromURL('gs://sakan-talaba-c6f0f.appspot.com/')
        .child(filePath);
